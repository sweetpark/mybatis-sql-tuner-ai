...
class SqlAnalyzerServiceTest {
	...
	void analyze_success() throws Exception {
		...
		SqlAnalyzerConfig config = new SqlAnalyzerConfig("jdbc:h2:mem:testdb;DB_CLOSE_DELAY=-1", "sa", "");
	...
	void loadJdbcDriver_allBranches() throws Exception {
		SqlAnalyzerService service = new SqlAnalyzerService();
		Method method = SqlAnalyzerService.class.getDeclaredMethod("loadJdbcDriver", String.class);
