...
class AnalyzeSqlActionTest {
	...
	void getActionUpdateThread_returnsBgt() {
		AnalyzeSqlAction action = new AnalyzeSqlAction();
	...
	void actionPerformed_nullHandling() {
		...
		// 2. null file
		Project mockProject = (Project) Proxy.newProxyInstance(AnalyzeSqlActionTest.class.getClassLoader(),
