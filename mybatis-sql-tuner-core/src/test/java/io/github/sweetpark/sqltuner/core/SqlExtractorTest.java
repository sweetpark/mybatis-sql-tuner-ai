...
class SqlExtractorTest {
	...
	void buildFakeSql_allTags() throws Exception {
		...
		String namespace = "io.github.sweetpark.sqltuner.core.mapper.FullFeaturesMapper";
		...
		assertTrue(fakeSql1.contains(
				"/* MISSING_INCLUDE: io.github.sweetpark.sqltuner.core.mapper.FullFeaturesMapper.missingColumns */"));
		...
		customRegistry.put("io.github.sweetpark.sqltuner.core.mapper.FullFeaturesMapper.corruptedSnippet",
				"NOT_VALID_XML <<<");
